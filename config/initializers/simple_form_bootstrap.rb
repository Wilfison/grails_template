...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid',
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                     valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label',
                                        tag: 'fieldset', class: 'form-group mb-2', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_collection_inline, item_wrapper_class: 'form-check form-check-inline',
                                               item_label_class: 'form-check-label', tag: 'fieldset', class: 'form-group mb-2', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
  ...
  # vertical file input
  config.wrappers :vertical_file, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                  valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
  ...
  config.wrappers :vertical_multi_select, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                          valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
  ...
  config.wrappers :vertical_range, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                   valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
  ...
  config.wrappers :custom_boolean, tag: 'fieldset', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                   valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :custom_boolean_switch, tag: 'fieldset', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                          valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :custom_collection_inline, item_wrapper_class: 'custom-control custom-control-inline',
                                             item_label_class: 'custom-control-label', tag: 'fieldset', class: 'form-group mb-2', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
  ...
  # custom file input
  config.wrappers :custom_file, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
  ...
  # custom multi select
  config.wrappers :custom_multi_select, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                        valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
  ...
  # custom range input
  config.wrappers :custom_range, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid',
                                 valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
  ...
  # config.wrappers :input_group, tag: 'div', class: 'form-group mb-2', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
  #   b.use :html5
  #   b.use :placeholder
  #   b.optional :maxlength
  #   b.optional :minlength
